...
|-------------|-------|------------|-------|
| Workstreams | 5 | - | 5 |
| Workstream Managers | 5 | 1 per workstream | 5 |
| Schools | 40 | 8 per workstream | 40 |
| School Managers | 40 | 1 per school | 40 |
| Teachers | 480 | 12 per school | 480 |
| Secretaries | 240 | 6 per school | 240 |
| Students | 2,000 | 50 per school | 2,000 |
| Guardians | ~1,200 | ~30 per school | ~1,200 |
| Courses | 1,440 | 36 per school | 1,440 |
| Classrooms | 480 | 12 per school | 480 |
| Assignments | ~33,600 | 7 per allocation | ~33,600 |
| Marks | ~thousands | per student/assignment | ~thousands |
| Learning Materials | ~thousands | 2-4 per course | ~thousands |
| Lesson Plans | ~thousands | 3-5 per course | ~thousands |
| Attendance Records | ~thousands | 20 days per student | ~thousands |
| Notifications | 500 | across all users | 500 |
| Messages | 200+ | threaded conversations | 200+ |
| Support Tickets | 100 | from various users | 100 |
| Staff Evaluations | ~hundreds | per manager | ~hundreds |
| Login History | 1,000 | across all users | 1,000 |
| Activity Logs | 1,500 | audit trail | 1,500 |
| System Configs | ~100 | global/ws/school | ~100 |
| **Total Users** | **~4,000+** | | **~4,000+** |
...
│       ├── School 1 (Riverside Middle School)
│       │   ├── School Manager 1
│       │   ├── 12 Teachers
│       │   ├── 6 Secretaries
│       │   ├── 50 Students
│       │   ├── ~30 Guardians
│       │   ├── 36 Courses, 12 Classrooms
│       │   ├── Assignments, Marks, Materials, Plans
│       │   └── Attendance Records (4 weeks)
│       ├── School 2 ... School 8
│       │   └── (same structure)
│
├── Workstream 2 (South Region Education District)
│   └── Workstream Manager 2
│       ├── School 9 ... School 16
│
├── Workstream 3 (East Region Education District)
│   └── Workstream Manager 3
│       ├── School 17 ... School 24
│
├── Workstream 4 (West Region Education District)
│   └── Workstream Manager 4
│       ├── School 25 ... School 32
│
└── Workstream 5 (Central Region Education District)
    └── Workstream Manager 5
        ├── School 33 ... School 40

Cross-school data:
├── 500 Notifications
├── 200+ Messages with receipts
├── 100 Support Tickets
├── Staff Evaluations
├── 1000 Login History records
├── 1500 Activity Logs
...
| Teacher | `{first}.{last}.t{N}@edutracker.com` | `alice.johnson.t0@edutracker.com` |
...
| Guardian | `{first}.{last}.g{N}@edutracker.com` | `mary.brown.g0@edutracker.com` |
...
- **Capacity:** 1000-5000 students (random)
- **Location:** Random city name

### Schools
- **Name:** "{City} {Type} School" (e.g., "Riverside Middle School")
- **Types:** Elementary, Middle, High, Secondary, Academy, Preparatory, International, Comprehensive
- **Capacity:** 500-1500 students
...
```python
# Number of workstreams (default: 5)
workstreams = self.create_workstreams(count=5)

# Number of schools per workstream (default: 8)
...
- [x] Add support for Guardian entity seeding
- [x] Create relationships between Students and Guardians
- [x] Add Course and ClassRoom seeding
- [x] Generate assignment and grade data
- [x] Add notification seeding for testing
- [x] Add message/messaging seeding
- [x] Add support ticket seeding
- [x] Add staff evaluation seeding
- [x] Add login history and activity log seeding
- [x] Add learning materials and lesson plans
- [x] Add system configuration seeding
...
✅ **~4,000+ realistic users across 7 role types**
✅ **All entity types seeded (assignments, marks, materials, plans, notifications, messages, tickets, evaluations, logs)**
